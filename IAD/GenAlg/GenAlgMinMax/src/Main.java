...
public class Main {
    ...
    public static void main( String[] args ){
        ...
        System.out.println("Our chromosome is:"+ maximum.population[0]);
        System.out.println((String.format("Genome = %s, x = %f, f(x) = %f", maximum.population[0].getGenome(),
                binaryToX(maximum.population[0].getGenome()), maximum.population[0].getFitness())));
